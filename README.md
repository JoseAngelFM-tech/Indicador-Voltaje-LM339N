...
Sistema indicador de voltaje basado en comparadores LM339N y modelado en Python.
...
- Clasificación automática de impedancia en:
  - Baja impedancia
  - Media impedancia
  - Alta impedancia
...
- Representación matricial básica de estados lógicos generados por las señales provenientes de los comparadores.
...
(Aquí puedes agregar las imágenes más adelante)

---

# Implementación Física

(Aquí puedes agregar fotografías del circuito y esquemáticos)
